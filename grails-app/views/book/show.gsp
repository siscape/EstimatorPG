	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<g:if test="${bookInstance?.dateIssued}">
				<li class="fieldcontain">
					<span id="dateIssued-label" class="property-label"><g:message code="book.dateIssued.label" default="Date Issued" /></span>
					
						<span class="property-value" aria-labelledby="dateIssued-label"><g:fieldValue bean="${bookInstance}" field="dateIssued"/></span>
				...
				<g:if test="${bookInstance?.numSold}">
				<li class="fieldcontain">
					<span id="numSold-label" class="property-label"><g:message code="book.numSold.label" default="Num Sold" /></span>
					
						<span class="property-value" aria-labelledby="numSold-label"><g:fieldValue bean="${bookInstance}" field="numSold"/></span>
