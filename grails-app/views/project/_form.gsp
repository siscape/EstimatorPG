...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'projectType', 'error')} ">
    ...
    <g:select name="projectType" from="${projectInstance.constraints.projectType.inList}"
              value="${projectInstance?.projectType}" valueMessagePrefix="project.projectType" noSelection="['': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'projectStatus', 'error')} ">
    ...
    <g:select name="projectStatus" from="${projectInstance.constraints.projectStatus.inList}"
              value="${projectInstance?.projectStatus}" valueMessagePrefix="project.projectStatus"
              noSelection="['': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'startDate', 'error')} ">
    ...
    <g:datePicker name="startDate" precision="day" value="${projectInstance?.startDate}" default="none"
                  noSelection="['': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'endDate', 'error')} ">
    ...
    <g:datePicker name="endDate" precision="day" value="${projectInstance?.endDate}" default="none"
                  noSelection="['': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'property', 'error')} ">
    ...
    <g:select id="property" name="property.id" from="${com.siscape.estimator.Property.list()}" optionKey="id"
              value="${projectInstance?.property?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'repairEstimate', 'error')} ">
    ...
    <g:select id="repairEstimate" name="repairEstimate.id" from="${com.siscape.estimator.RepairEstimate.list()}"
              optionKey="id" value="${projectInstance?.repairEstimate?.id}" class="many-to-one"
              noSelection="['null': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'profitEstimate', 'error')} ">
    ...
    <g:select id="profitEstimate" name="profitEstimate.id" from="${com.siscape.estimator.ProfitEstimate.list()}"
              optionKey="id" value="${projectInstance?.profitEstimate?.id}" class="many-to-one"
              noSelection="['null': '']"/>
</div>
